...
class Camera_Subscriber():
    def __init__(self,topicName_rgb=False,topicName_dpt=False,topicName_camInfo=False,savePath=False):
        ...
        if savePath:
            ...
            self.video=cv2.VideoWriter(savePath,fourcc, 20.0,(640,480))
...
savePath = "/home/hayashide/catkin_ws/src/object_detector/scripts/monitor/rgb.mp4"
cam=Camera_Subscriber(topic_name_rgb,topic_name_dpt,topic_name_inf,savePath)
if savePath:
    cam.video.release()
