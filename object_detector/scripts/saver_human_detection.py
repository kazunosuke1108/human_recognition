...
class Human_tracking():
    ...
    def get_position(self,rgb_array,dpt_array,obj_people,P):
        ...
        for i,row in enumerate(obj_people.itertuples()):
            ...
            # try:
            #     with open('/home/hayashide_kazuyuki/catkin_ws/src/object_detector/csv/0831_3.csv','a') as f:
            #         writer=csv.writer(f)
            #         writer.writerow(round(dpt/1000,3))
            # except FileNotFoundError:
            #     with open('/home/hayashide_kazuyuki/catkin_ws/src/object_detector/csv/0831_3.csv','w') as f:
            #         writer=csv.writer(f)
            #         writer.writerow(round(dpt/1000,3))
    ...
    def export_log(self,now,rect_list): # rect_listが一番嬉しい
        ...
        np.savetxt('/home/hayashide_kazuyuki/catkin_ws/src/object_detector/csv/0902_0.csv',self.history,delimiter=",")
    ...
    def ImageCallback(self,rgb_data,dpt_data,info_data):
        try:
            ...
            # imshow
            results.render()
            # self.color.append(results.imgs[0])
            ...
            # # self.depth.append(dpt_array_show)
